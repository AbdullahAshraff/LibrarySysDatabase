...
-- Insert into Author
INSERT INTO Author (ID, Name, BirthDate, Biography) VALUES
...
-- Insert into Book
INSERT INTO Book (ID, ISBN, Title, Year_of_publication, Edition, Publisher_ID, Category_ID, Author_ID) VALUES
...
-- Insert into Admin
INSERT INTO Admin (ID, Name, Email, Phone, Username, Password, Hire_Date, Position) VALUES
...
-- Insert into Branch
INSERT INTO Branch (ID, Location, Name, Phone, AdminId) VALUES
...
-- Insert into Member
INSERT INTO Member (Member_ID, Name, Email, Phone, Username, Password, Gender) VALUES
...
INSERT INTO Membership (Membership_ID, Type, DurationDays, Fee) VALUES
(1, 'Monthly', 30, 15.00),
...
-- Insert into Message
INSERT INTO Message (ID, MemberID, AdminID, IsMemberSender, TimeSent, Content) VALUES
(1, 1, 1, 1, '2024-12-28 10:00:00', 'I need help with renewing my membership.'),
(2, 2, 2, 0, '2024-12-28 10:05:00', 'Your membership has been renewed.'),
(3, 3, 3, 1, '2024-12-28 10:15:00', 'Is the library open on weekends?'),
(4, 4, 4, 0, '2024-12-28 10:20:00', 'Yes, we are open on weekends.'),
(5, 5, 5, 1, '2024-12-28 10:30:00', 'Can I request a new book?'),
(6, 6, 1, 0, '2024-12-28 10:35:00', 'Sure, please submit your request form.'),
(7, 7, 2, 1, '2024-12-28 10:45:00', 'I forgot my login password.'),
(8, 8, 3, 0, '2024-12-28 10:50:00', 'We have sent a password reset link.'),
(9, 9, 4, 1, '2024-12-28 11:00:00', 'Can I extend my borrowed books?'),
(10, 10, 5, 0, '2024-12-28 11:05:00', 'Yes, please visit the branch.');

-- Insert into Report
INSERT INTO Report (ID, Type, AdminID, Content, Created_Date) VALUES
...
INSERT INTO BorrowReturn (Member_ID, Book_ID, Branch_ID, Issue_Date, Return_Date) VALUES
...
INSERT INTO Stored_at (Book_ID, Branch_ID, Available_Copies) VALUES
(1, 1, 5),
(2, 2, 3),
(3, 3, 4),
(4, 4, 6),
